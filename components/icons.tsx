...
export const DebtIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const NetWorthIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.124 6.324A2.25 2.25 0 015.375 4.5h13.25c1.243 0 2.25 1.007 2.25 2.25v1.438a2.251 2.251 0 01-.73-1.688H5.375a2.251 2.251 0 01-2.25-2.25v-.062zM3.124 9.438c0-.39.158-.75.438-1.02a2.25 2.25 0 011.812-1.02h13.25c.39 0 .75.158 1.02.438a2.25 2.25 0 011.02 1.812v6.812a2.25 2.25 0 01-2.25 2.25H5.375a2.25 2.25 0 01-2.25-2.25V9.438z" />
    </svg>
);
